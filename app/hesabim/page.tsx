...
import { ClipboardDocumentListIcon, ShoppingCartIcon, Cog6ToothIcon, ArrowRightOnRectangleIcon, ArrowLeftIcon, HeartIcon, LifebuoyIcon } from "@heroicons/react/24/outline";
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-12">
          <aside className="lg:col-span-3 rounded-3xl border border-white/10 bg-slate-900/75 p-4 shadow-[0_20px_60px_rgba(2,6,23,0.55)] backdrop-blur-2xl">
            <nav className="space-y-2 ">
              ...
              <Link href="/hesabim/destek-al" className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-semibold text-white/85 transition-colors hover:bg-white/10 hover:text-white">
